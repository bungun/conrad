...
# res_mpc = mpc_treatment(A_list, F, G, r, h_init, patient_rx, health_map = health_map, solver = "MOSEK")
# print("MPC Treatment")
...
# plot_beams(res_mpc["beams"], stepsize = 4, cmap = transp_cmap(plt.cm.Reds), norm = lc_norm, \
# 			  structures = (theta_grid, r_grid, regions), struct_kw = struct_kw, filename = "ex_noisy_mpc_beams.png")
# plot_health(res_mpc["health"], curves = curves, stepsize = 10, bounds = (health_lower, health_upper), filename = "ex_noisy_mpc_health.png")
