...
class TestPhysics(ConradTestCase):
	def test_percent_parse(self):
		...
		self.assertEqual( f_output, 7. )
		self.assertIsInstance( value, Percent )
	...
	def test_volume_parse(self):
		...
		self.assertIsInstance( unit, CM3 )
		output = strip_volume_units(input_)
		self.assertEqual( output, '3 ' )
		f_output = float_value_from_volume_string(input_)
		self.assertEqual( f_output, 3 )
		v_output = volume_from_string(input_)
		self.assertIsInstance( v_output, CM3 )
		self.assertEqual( v_output.value, 3. )
		...
		input_ = '3 mm3'
		unit = volume_unit_from_string(input_)
		self.assertIsInstance( unit, MM3 )
		output = strip_volume_units(input_)
		self.assertEqual( output, '3 ' )
		f_output = float_value_from_volume_string(input_)
		self.assertEqual( f_output, 3 )
		v_output = volume_from_string(input_)
		self.assertIsInstance( v_output, MM3 )
		self.assertEqual( v_output.value, 3. )
	...
	def test_dose_parse(self):
		...
		self.assertIsInstance( unit, Gray )
		output = strip_dose_units(input_)
		self.assertEqual( output, '5 ' )
		f_output = float_value_from_dose_string(input_)
		self.assertEqual( f_output, 5. )
		d_output = dose_from_string(input_)
		self.assertIsInstance( d_output, Gray )
		self.assertEqual( d_output.value, 5 )
		...
		input_ = '5 cgy'
		unit = dose_unit_from_string(input_)
		self.assertIsInstance( unit, centiGray )
		output = strip_dose_units(input_)
		self.assertEqual( output, '5 ' )
		f_output = float_value_from_dose_string(input_)
		self.assertEqual( f_output, 5. )
		d_output = dose_from_string(input_)
		self.assertIsInstance( d_output, centiGray )
		self.assertEqual( d_output.value, 5 )
	...
	def test_dose_or_percent_parse(self):
		...
		self.assertIsInstance( output, Gray )
		self.assertEqual( output.value, 5 )

		input_ = '50 %'
		output = percent_or_dose_from_string(input_)
		self.assertIsInstance( output, Percent )
		self.assertEqual( output.value, 50 )
